...
const COLORREF CLR_XY = RGB(0, 0, 255); //blue 
const COLORREF CLR_YZ = RGB(0, 255, 0); //green
const COLORREF CLR_ZX = RGB(255, 255, 0); //yellow
const COLORREF CLR_XYZ = RGB(255, 0, 0); //red
const COLORREF CLR_REST = RGB(0, 255, 255); // cyan
